...
module.exports = function(options) {
    ...
    // Add the acl control for uploaded object, default is public read
    ...
    return function handler(req, res, next) {
        ...
        var upload = function(fieldname, callback) {
            ...
            var data = {
                ...
                'Body'          : bodyStream,
                'Acl'           : acl,
                'ContentType'   : req.files[fieldname].contentType || mime.lookup(req.files[fieldname].s3ObjectName),
            };
